...
export default function TextHeart() {
  ...
  useEffect(() => {
    ...
    const draw = (time: number) => {
      ...
      if (img.complete && img.naturalWidth > 0 && elapsed > 1000) {
        const imgAlpha = Math.min(1, (elapsed - 1000) * 0.001);
        ctx.save();
        ...
        const targetWidth = 26 * scale;
        const targetHeight = 26 * scale;
